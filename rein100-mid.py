...
def parse_args():
    ...
    parser.add_argument('--run_file',type=str, default='rein100-mid.py')
    ...
    parser.add_argument('--type',type=str, default='mid') #updd mid
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            for node_type, data_loader in train_data_loader.items():
                ...
                for batch in pbar:
                    ...
                    if (args.type=='updd' or args.type=='mid'):
                        train_loss_left=train_loss_right
                    else:
                    ...
                    logger.info(f"Epoch {epoch}, {node_type}, loss1 MSE: {(right_loss1.item()):.2f}, loss2 MSE: {(right_loss2.item()):.2f}, loss3 MSE: {(right_loss3.item()):.2f}")
