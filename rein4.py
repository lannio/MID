...
def parse_args():
    ...
    parser.add_argument('--run_file',type=str, default='rein4.py')
...
class OUR():
    ...
    def train(self):
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            #         train_loss_left=left_loss1/args.loss_gau_rate
            ...
            # logger.info(f"DE {epoch}, {node_type},select_FDE: {(select_fde):.2f} ")
                ...
                with torch.no_grad():
                    ...
                    for node_type_test, data_loader_test in eval_data_loader.items():
                        ...
                        for test_batch in pbar2:
                            ...
                            ade, fde=get_pred_de(traj_pred, self.test_end)
