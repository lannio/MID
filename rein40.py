...
def parse_args():
    ...
    parser.add_argument('--run_file',type=str, default='rein40.py')
    ...
    parser.add_argument('--exp',type=str, default='40-noDiffusion')
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            for node_type, data_loader in train_data_loader.items():
                ...
                for batch in pbar:
                    ...
                    train_loss_left=left_loss1/args.loss_gau_rate+select_fde/args.loss_mean_rate
