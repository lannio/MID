...
# args temp
def parse_args():
    # direct diffusion without select
    parser = argparse.ArgumentParser()
    parser.add_argument('--run_file',type=str, default='rein30.py')
    parser.add_argument('--config_file',type=str, default='./configs/baseline.yaml')

    parser.add_argument('--folder_date',type=str, default='ablation')
    parser.add_argument('--dataset',type=str, default='univ')
    parser.add_argument('--exp',type=str, default='30-onlyDiffusion')
...
def find_end_20(gauss_param_tensor):
    gauss_param_tensor = gauss_param_tensor[:,0,:]
    ...
    return gauss_distribution.sample()
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            for node_type, data_loader in train_data_loader.items():
                ...
                for batch in pbar:
                    ...
                    # selected_end = find_end_20(end_feat)
                    # left_loss3 = 1/probs
            ...
            with torch.no_grad():
                ...
                for node_type_test, data_loader_test in eval_data_loader.items():
                    ...
                    for test_batch in pbar2:
                        ...
                        # selected_end = find_end_20(traj_pred)
